...
sh -x $ETERPACK update --depth 3 --exclude /stage1/stage2/stage3/stage4 sample packed || fatal "update failed"
...
[ -d unpacked/stage1/stage2/stage3 ] || fatal "missed stage1/stage2/stage3 dir"

[ -d unpacked/stage1/stage2/stage3/stage4 ] && fatal "excluded stage1/stage2/stage3/stage4 dir is exists"

$ETERPACK check packed || fatal "check failed"

cp -al sample sample-mod
rm -rf sample-mod/stage1/stage2/stage3/stage4
